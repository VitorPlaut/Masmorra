...
comando[strlen(comando) - 1] = '\0';
  ...
  if (strcmp(comando, "norte") == 0 || strcmp(comando, "n") == 0) {
            if (x > 0) {
                ...
                printf(VERMELHO "Não dá para ir ao norte!\n" RESETAR);
            }
        }
            ...
            if (x < LINHAS-1) {
                ...
                printf(VERMELHO "Não dá para ir ao sul!\n" RESETAR);
            }
        }
            ...
            if (y < COLUNAS-1) {
                ...
                printf(VERMELHO "Não dá para ir ao leste!\n" RESETAR);
            }
        }
            ...
            if (y > 0) {
                ...
                printf(VERMELHO "Não dá para ir ao oeste!\n");
				 if (strcmp(comando, "norte") == 0 || strcmp(comando, "n") == 0) {
            if (x > 0) {
                x--;
            } else {
